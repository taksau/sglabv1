...
class BasicSceneGraphEvaluator:
    ...
    def print_stats(self):
        ...
        print('objects_AP: ', np.mean(self.result_dict['objects_AP']))
        return output
...
def evaluate_from_dict(gt_entry, pred_entry, mode, result_dict, multiple_preds=False,
    ...
    result_dict['objects_AP'].append((gt_classes[vaild_mask] == pred_classes[vaild_mask]).mean())
