...
from lib.fpn.box_utils import bbox_preds, center_size, bbox_overlaps, point_form, nms_cython
# from lib.fpn.nms.functions.nms import apply_nms, nms_simplify, _nms_single_im
...
# from lib.slices_vgg16 import Slices_VGG
import time
...
def apply_nms(scores, boxes, pre_nms_topn=12000, post_nms_topn=2000, boxes_per_im=None,
    ...
    for bpi in boxes_per_im:
        e = s + int(bpi)
        keep_im = nms_cython(scores[s:e], boxes[s:e], pre_nms_topn, post_nms_topn, nms_thresh)
...
class Result(object):
    ...
    def __init__(self, od_obj_dists=None, rm_obj_dists=None,
                 ...
                 od_box_targets=None, rm_box_targets=None, od_box_priors=None, od_im_inds=None,
                 rm_box_priors=None,
                 ...
                 im_inds=None, fmap=None, rel_dists=None, rel_inds=None, rel_rep=None, subj_rep=None,
                 obj_rep=None, subj_rep_gate=None, obj_rep_gate=None, im_f=None, od_obj_scores=None, obj_dists_head=None,
                 atten_norm=None, rank_factor=None):
...
class ObjectDetector(nn.Module):
    ...
    #     new_backbone = Slices_VGG()
    #     new_backbone.get_weight(self.features)
    #     self.features = new_backbone
    ...
    def forward(self, x, im_sizes, image_offset,
        ...
        od_im_inds = rois[:, 0].long().contiguous() + image_offset
